                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <img id="showImage" class="rounded-circle" src=" {{ (!empty($user->image)) ? url('upload/user_images/'.$user->image) : url('upload/avatar-1.png')  }} " alt="User Avatar" style="width:100px;height:100px;border:1px solid #000">
                                                </div>
